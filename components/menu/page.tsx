...
export default function Menu() {
    ...
    return (
      ...
      <div className={`transition-all transform ${isOpen ? 'rotate-45' : 'rotate-0'}`} onClick={toggleMenu}><AllOutIcon sx={{ fontSize: 14 }} className='text-[5vw]'/></div>
      {isOpen && (
        <div className="absolute top-[50px] right-0 mt-2 w-48 bg-white shadow-lg rounded-[5px] z-50">
          <ul className="py-[15px] text-[15px]">
