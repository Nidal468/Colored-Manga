        ...
        >
            {data.map((slider) => (
                <SwiperSlide key={slider.id}>
                    ...
                    <div className="lg:w-[200px] lg:h-[230px] w-[24vw] h-[28vw] relative" ><Image fill={true} src={slider.image} alt="" className='object-cover' /></div>
                    <div className="w-full lg:h-[230px] h-[28vw]">
                        ...
                        <div className="w-full h-full flex z-5 bg-black bg-opacity-60 backdrop-blur-[20px] text-white">
                            <div className="w-full p-[5px] flex-col justify-start items-start flex">
                                <div className="self-stretch p-[10px] justify-between items-center gap-[5px] inline-flex">
                                    <div className="flex-col justify-center items-start gap-[5px] inline-flex">
                                        <div className="text-[3vw] lg:text-[20px] font-medium">{slider.title}</div>
                                        <div className="self-stretch grow shrink basis-0 justify-start items-center gap-[10px] inline-flex text-[2vw] lg:text-[12px] font-medium">
                                    ...
                                    <div className="w-[5vw] h-[5vw] lg:w-[30px] lg:h-[30px] rounded-[0.5vw] lg:rounded-[0.3vw] justify-center items-center flex">
                                        <div className="text-[1.5vw] lg:text-[10px] font-medium">{slider.rating}</div>
                                    </div>
                                </div>
