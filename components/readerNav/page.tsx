...
export default function Nav(props: any) {
    ...
    return (
        <div className='h-[50px] lg:px-5 lg:py-2.5 px-2 py-1.5 justify-between items-center flex fixed top-0 left-0 z-50 text-white' id={theme.solid} style={{ boxShadow: "0px 0px 0px #0b0b0b", width: props.width}}>
