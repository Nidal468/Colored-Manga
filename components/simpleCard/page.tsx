...
export default function Scard(props: any) {
    return (
        <div className="w-[30vw] h-[52vw] lg:w-[160px] lg:h-[269px] flex flex-col items-center justify-between overflow-hidden lg:rounded-[8px] rounded-[1vw]" id={themes.outside}>
            ...
            <div className='px-[10px] py-[5px] bg-zinc-800 absolute left-0 flex items-center justify-center text-[10px] lg:rounded-tl-[8px] rounded-tl-[1vw] lg:rounded-br-[8px] rounded-br-[1vw] font-medium'><h1>B/W</h1></div>
