...
export default function Card(props: any){
    return(
      ...
      <div className="w-[28vw] h-[30vw] lg:w-[200px] lg:h-[190px] bg-white relative">
        <Image fill={true} src="/images/assets/fpr.jpg" alt="" className='object-cover'/>
      </div>
      <div className="w-full lg:py-[5px] py-[2vw] flex flex-col justify-center items-center gap-[1.2vw] lg:gap-[12px] text-[1.5vw] lg:text-[12px]">
