...
export default function Update() {
    return(
        <div className="w-[22vw] h-[22vw] p-2.5 rounded-[1vw] flex-col justify-between items-start lg:inline-flex hidden" id={theme.update}>
  ...
  <div className="self-stretch h-full py-[0.5vw] flex-col justify-between items-start flex text-white text-sm font-light">
    <div className='self-stretch flex flex-col items-start justify-start gap-[1vw]'>
    <div className="self-stretch px-2.5 py-[5px] rounded-sm justify-between items-center inline-flex" id={theme.updateSub}>
      <div className="justify-center items-center gap-2.5 flex">
        <AndroidIcon sx={{color: "#fff"}}/>
        <div>Patched  Bugs</div>
      </div>
      <div>12</div>
    </div>
    <div className="self-stretch px-2.5 py-[5px] rounded-sm justify-start items-center gap-2.5 inline-flex" id={theme.updateSub}>
      <div className="justify-center items-center gap-2.5 flex">
    ...
    <div className="Frame3680 self-stretch px-2.5 rounded justify-between items-center inline-flex" id={theme.updateSub}>
      <div className="Frame3680 justify-center items-center gap-2.5 flex">
  ...
  <div className="Frame3674 self-stretch bg-white bg-opacity-10 rounded-[200px] justify-between items-center inline-flex cursor-pointer pr-[0.3vw]">
    <a href='https://discord.com/invite/WuXp4MY9aU'><img className="Image8 w-[32px] h-[32px]" src="/images/icons/discord.png" /></a>
