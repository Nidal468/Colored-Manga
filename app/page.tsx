...
export default async function Home() {
  console.log("hello")
  return (
    <div className="w-full font-light flex flex-col items-start justify-start pt-[2vw] lg:pt-[5vw] gap-[2vw]" id={themes.body}>
      <Nav />
      ...
      <div className="sideway w-full flex flex-col gap-[1vw] px-[1vw]">
      ...
      <div className="view w-full flex flex-col lg:flex-row items-start justify-between lg:gap-[2vw] gap-[8vw] px-[1vw]">
        <div className="topMangas w-full lg:w-[60vw] flex-col justify-start items-center gap-[2vw] lg:gap-[2vw] inline-flex lg:border-r-2 lg:border-gray-300">
          ...
          <div className="w-[20%] lg:py-[0.5vw] py-[1vw] rounded-[0.3vw] justify-center items-center flex text-white text-[2vw] lg:text-[1vw] font-light gap-[1vw]" id={themes.button}><AutorenewIcon className="text-[4vw] lg:text-[2vw]"/>Load More</div>
        </div>
        <Popularity />
      </div>
      <Footer />
