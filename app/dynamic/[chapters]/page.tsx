...
export default function Chapters() {
    return (
        <div className="w-full font-light pl-[7%] pt-[6vw] pr-[2vw] lg:pr-[1vw] flex items-start justify-start gap-[2vw]" id={themes.body}>
            <Nav />
            ...
            <div className='w-[30vw] flex flex-col items-start justify-start gap-[1vw] p-[2vw] text-[1vw]' id={themes.box}>
