...
export async function POST(req: NextRequest, res: NextResponse) {
    try {
        ...
        const { username, password, token, id, verification, createdAt, email, avater, bookmark } = formData
        ...
        user.push({id, username, password, verification, token, createdAt, email, avater, bookmark })
